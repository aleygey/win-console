/**
 * Crisp line icons (Lucide paths, MIT) replacing the emoji that made the UI look
 * amateur. Stroke-based, inherit currentColor + size, so they tint with the
 * design tokens. Inlined as SVG markup strings (no dependency, works offline).
 */
...
const PATHS: Record<string, string> = {
  ...
  paperclip:
    '<path d="M13.234 20.252 21 12.3a4.5 4.5 0 0 0-6.364-6.364L4.95 15.622a3 3 0 0 0 4.243 4.243l8.486-8.486"/>',
  "trash-2":
...
export function Icon(props: { name: string; size?: number; class?: string }): JSX.Element {
  ...
  return (
    <svg
      ...
      innerHTML={PATHS[props.name] ?? PATHS.circle}
    />
  )
}
